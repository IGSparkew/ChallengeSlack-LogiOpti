...
final class Version20240109094222 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME DEFAULT NULL, toll_cost NUMERIC(12, 10) DEFAULT NULL, start_location VARCHAR(255) NOT NULL, end_location VARCHAR(255) NOT NULL, energy_cost NUMERIC(12, 10) DEFAULT NULL, using_cost NUMERIC(12, 10) DEFAULT NULL, distance NUMERIC(12, 10) DEFAULT NULL, time TIME DEFAULT NULL, payload VARCHAR(255) DEFAULT NULL, array_coordinates LONGTEXT DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, INDEX IDX_3781EC10545317D1 (vehicle_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) DEFAULT NULL, max_load INT DEFAULT NULL, kilometer_cost NUMERIC(12, 10) DEFAULT NULL, average_comsumption NUMERIC(10, 2) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
