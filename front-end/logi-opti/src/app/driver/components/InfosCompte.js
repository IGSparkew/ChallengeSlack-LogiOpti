export default function InfosCompte() {
    return(
        <div className="flex flex-col gap-5 items-center justify-center bg-white px-5 shadow-box py-5">
            ...
            <div className="mt-5 w-full">
                ...
                <input defaultValue={"BENALIA"} className="bg-redFullClair w-full h-10 rounded px-5 u-r mt-1" type="text" />
            </div>
            <div className="mt-5 w-full">
                <label className="u-m text-sm">Prenom</label>
                <input defaultValue={"Mohamed"}  className="bg-redFullClair w-full h-10 rounded px-5 u-r mt-1 " type="text" />
            </div>
            <div className="mt-5 w-full">
                <label className="u-m text-sm">Adresse e-mail</label>
                <input defaultValue={"mbenalia@logiopti.fr"} className="bg-redFullClair w-full h-10 rounded px-5 u-r mt-1" type="text" />
            </div>
            <div className="mt-5 w-full">
                <label className="u-m text-sm">Mot de passe (Non modifiable)</label>
                <input disabled  defaultValue={"password"} type="password" className="bg-slate-200 w-full h-10 rounded px-5 u-r mt-1 text-3xl disabled" />
            </div>
            <div className="mt-5 w-full">
